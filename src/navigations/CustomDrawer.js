...
import { View, StyleSheet, TouchableOpacity, Linking, Text, Image, StatusBar, FlatList } from 'react-native';
        ...
        <View style={{ flex: 1 }}>
            ...
            <DrawerContentScrollView {...props}>
                ...
                <View style={styles.root}>
                    <Avatar.Image
                        size={70}
                        style={{ backgroundColor: '#fff', marginTop: 40, marginLeft: 10, }}
                    ...
                    />
                    <Text style={styles.text}>Sign In Or SignUp</Text>
                </View>
                ...
                <DrawerItem
                    ...
                    label="Learning"
                    // onPress={() => { props.navigation.navigate('Dictionary') }}
                    onPress={() => { alert('Learning') }}
                />



                {/* <TouchableOpacity onPress={() => alert('Notes Added')}> */}
                {/* <TouchableOpacity onPress={() => props.navigation.navigate('AddList')}> */}
                <TouchableOpacity onPress={() => alert('AddList')}>
                    <View style={styles.addlisticon}>
                        ...
                        />
                        <Text style={{ marginTop: 10, marginLeft: 10, fontWeight: '700', }}>
                            Add List
                        </Text>
                    </View>
                </TouchableOpacity>
